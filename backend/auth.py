...
class UserManager:
    ...
    def update_user(self, user_id, updates, admin_user_id='admin'):
        ...
        for user in users:
            if user['user_id'] == user_id:
                ...
                # Log activity
                self.log_activity(admin_user_id, 'user_updated', f"User {user['username']} updated")
                
                return {'success': True, 'message': 'User updated successfully'}
        
        return {'success': False, 'message': 'User not found'}
    
    def deactivate_user(self, user_id, admin_user_id='admin'):
        """Deactivate user"""
        users = self.load_users()
        ...
        for user in users:
            if user['user_id'] == user_id:
                ...
                # Log activity
                self.log_activity(admin_user_id, 'user_deactivated', f"User {user['username']} deactivated")
                
                return {'success': True, 'message': 'User deactivated successfully'}
        
        return {'success': False, 'message': 'User not found'}
    
    def delete_user(self, user_id, admin_user_id='admin'):
        ...
        # Log activity
        self.log_activity(admin_user_id, 'user_deleted', f"User {user_to_delete['username']} deleted permanently")
